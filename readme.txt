...
Tags: twilio, sms,notification,OTP, Woocommerce SMS
...
Best SMS Plugin for WordPress.Contact Form 7 SMS/Gravity Forms, WooCommerce SMS Alerts.Custom SMS Gateways for OTP Verification ( Twilio & More).

== Description ==

[WordPress SMS Plugin](https://www.wpsms.io/): If you've ever wanted to enable sending SMS from your wordpress website or app, This plugin was created for this by using [Twilio](https://www.twilio.com/),One of the best SMS solutions on the market. And they're reasonably priced and have an excellent API. 
...
* More integrations to come next. Check out [more addons here](https://wpsms.io/sms-plugins/).

// If you want us to create a custom addon for your plugin or a theme, contact us , We will be happy to help You.

-------

Visit the [WordPress SMS Plugin](https://wpsms.io/) for full integration details. Contributors are welcome to send pull requests via [GitHub repository](https://github.com/mohsinoffline/wp-twilio-core).
...
The plugin is free, but you will need to signup on [Twilio](https://www.twilio.com/), and obtain a number with SMS capability. However, they have trial accounts available which should have enough credit for you to try out the plugin!
...
= 1.5.5 =
*/ Fixed twl-fremius bug

= 1.5.4 =
*/ Fixed minor bugs
*/ Fixed Freemius bugs related to php8 compatibility
