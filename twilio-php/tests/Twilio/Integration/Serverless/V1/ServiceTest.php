...
namespace Twilio\Tests\Integration\Serverless\V1;
...
class ServiceTest extends HolodeckTestCase {
    public function testReadRequest() {
        ...
        try {
            $this->twilio->serverless->v1->services->read();
    ...
    public function testReadEmptyResponse() {
        ...
        $actual = $this->twilio->serverless->v1->services->read();
    ...
    public function testFetchRequest() {
        ...
        try {
            $this->twilio->serverless->v1->services("ZSXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")->fetch();
        } catch (DeserializeException $e) {}
          catch (TwilioException $e) {}
    ...
    public function testFetchResponse() {
        ...
        $actual = $this->twilio->serverless->v1->services("ZSXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")->fetch();
    ...
    public function testDeleteRequest() {
        ...
        try {
            $this->twilio->serverless->v1->services("ZSXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")->delete();
        } catch (DeserializeException $e) {}
          catch (TwilioException $e) {}
    ...
    public function testDeleteResponse() {
        ...
        $actual = $this->twilio->serverless->v1->services("ZSXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")->delete();
    ...
    public function testCreateRequest() {
        ...
        try {
            $this->twilio->serverless->v1->services->create("unique_name", "friendly_name");
        } catch (DeserializeException $e) {}
          catch (TwilioException $e) {}

        $values = array('UniqueName' => "unique_name", 'FriendlyName' => "friendly_name", );
    ...
    public function testCreateResponse() {
        ...
        $actual = $this->twilio->serverless->v1->services->create("unique_name", "friendly_name");
    ...
    public function testUpdateRequest() {
        ...
        try {
            $this->twilio->serverless->v1->services("ZSXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")->update();
        } catch (DeserializeException $e) {}
          catch (TwilioException $e) {}
    ...
    public function testUpdateResponse() {
        ...
        $actual = $this->twilio->serverless->v1->services("ZSXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX")->update();
